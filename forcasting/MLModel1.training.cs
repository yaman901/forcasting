...
namespace Forcasting
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\asus\Downloads\Books\Must read\EURUSD_historical_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:26,seriesLength:418,trainSize:703,horizon:5,outputColumnName:@"Change(%)",inputColumnName:@"Change(%)",confidenceLowerBoundColumn:@"Change(%)_LB",confidenceUpperBoundColumn:@"Change(%)_UB");
